...
const file_proto_user_proto_rawDesc = "" +
	...
	"\bpassword\x18\x03 \x01(\tR\bpassword2\xf6\t\n" +
	"\vUserService\x12T\n" +
	"\x16CheckUserExistsByEmail\x12#.user.CheckUserExistsByEmailRequest\x1a\x15.user.CheckedResponse\x12Z\n" +
	"\x19CheckUserExistsByUsername\x12&.user.CheckUserExistsByUsernameRequest\x1a\x15.user.CheckedResponse\x12N\n" +
...
var file_proto_user_proto_goTypes = []any{
	(*CheckUserExistsByIdRequest)(nil),       // 0: user.CheckUserExistsByIdRequest
	(*GetByUserIdRequest)(nil),               // 1: user.GetByUserIdRequest
	(*UsersPublicResponse)(nil),              // 2: user.UsersPublicResponse
	(*GetOneRequest)(nil),                    // 3: user.GetOneRequest
	(*GetManyRequest)(nil),                   // 4: user.GetManyRequest
	...
	(*UpdatedResponse)(nil),                  // 15: user.UpdatedResponse
	(*UpdateUserPasswordRequest)(nil),        // 16: user.UpdateUserPasswordRequest
	(*CheckUserExistsByEmailRequest)(nil),    // 17: user.CheckUserExistsByEmailRequest
	(*CheckUserExistsByUsernameRequest)(nil), // 18: user.CheckUserExistsByUsernameRequest
	(*CheckedResponse)(nil),                  // 19: user.CheckedResponse
	(*UserResponse)(nil),                     // 20: user.UserResponse
	(*ProfileResponse)(nil),                  // 21: user.ProfileResponse
	(*UserPublicResponse)(nil),               // 22: user.UserPublicResponse
	(*GetUserByUsernameRequest)(nil),         // 23: user.GetUserByUsernameRequest
	(*CreateUserRequest)(nil),                // 24: user.CreateUserRequest
}
var file_proto_user_proto_depIdxs = []int32{
	22, // 0: user.UsersPublicResponse.users:type_name -> user.UserPublicResponse
	8,  // 1: user.AddressesResponse.addresses:type_name -> user.AddressResponse
	21, // 2: user.UserResponse.profile:type_name -> user.ProfileResponse
	21, // 3: user.UserPublicResponse.profile:type_name -> user.ProfileResponse
	17, // 4: user.UserService.CheckUserExistsByEmail:input_type -> user.CheckUserExistsByEmailRequest
	18, // 5: user.UserService.CheckUserExistsByUsername:input_type -> user.CheckUserExistsByUsernameRequest
	0,  // 6: user.UserService.CheckUserExistsById:input_type -> user.CheckUserExistsByIdRequest
	3,  // 7: user.UserService.GetUserPublicById:input_type -> user.GetOneRequest
	3,  // 8: user.UserService.GetUserById:input_type -> user.GetOneRequest
	13, // 9: user.UserService.GetUserPublicByEmail:input_type -> user.GetUserByEmailRequest
	23, // 10: user.UserService.GetUserByUsername:input_type -> user.GetUserByUsernameRequest
	24, // 11: user.UserService.CreateUser:input_type -> user.CreateUserRequest
	16, // 12: user.UserService.UpdateUserPassword:input_type -> user.UpdateUserPasswordRequest
	14, // 13: user.UserService.UpdateProfile:input_type -> user.UpdateProfileRequest
	12, // 14: user.UserService.UpdateMeasurement:input_type -> user.UpdateMeasurementRequest
	1,  // 15: user.UserService.GetMeasurementByUserId:input_type -> user.GetByUserIdRequest
	1,  // 16: user.UserService.GetAddressesByUserId:input_type -> user.GetByUserIdRequest
	9,  // 17: user.UserService.CreateAddress:input_type -> user.CreateAddressRequest
	10, // 18: user.UserService.UpdateAddress:input_type -> user.UpdateAddressRequest
	6,  // 19: user.UserService.DeleteAddress:input_type -> user.DeleteAddressRequest
	4,  // 20: user.UserService.GetUsersPublicById:input_type -> user.GetManyRequest
	19, // 21: user.UserService.CheckUserExistsByEmail:output_type -> user.CheckedResponse
	19, // 22: user.UserService.CheckUserExistsByUsername:output_type -> user.CheckedResponse
	19, // 23: user.UserService.CheckUserExistsById:output_type -> user.CheckedResponse
	22, // 24: user.UserService.GetUserPublicById:output_type -> user.UserPublicResponse
	20, // 25: user.UserService.GetUserById:output_type -> user.UserResponse
	22, // 26: user.UserService.GetUserPublicByEmail:output_type -> user.UserPublicResponse
	20, // 27: user.UserService.GetUserByUsername:output_type -> user.UserResponse
	22, // 28: user.UserService.CreateUser:output_type -> user.UserPublicResponse
	15, // 29: user.UserService.UpdateUserPassword:output_type -> user.UpdatedResponse
	22, // 30: user.UserService.UpdateProfile:output_type -> user.UserPublicResponse
	11, // 31: user.UserService.UpdateMeasurement:output_type -> user.MeasurementResponse
	11, // 32: user.UserService.GetMeasurementByUserId:output_type -> user.MeasurementResponse
	7,  // 33: user.UserService.GetAddressesByUserId:output_type -> user.AddressesResponse
	8,  // 34: user.UserService.CreateAddress:output_type -> user.AddressResponse
	8,  // 35: user.UserService.UpdateAddress:output_type -> user.AddressResponse
	5,  // 36: user.UserService.DeleteAddress:output_type -> user.DeletedResponse
	2,  // 37: user.UserService.GetUsersPublicById:output_type -> user.UsersPublicResponse
